                        ...
                        struct tls_root_ctx *const ssl_ctx)
{
    ...
    ALLOC_OBJ_CLEAR(ssl_ctx->crt_chain, mbedtls_x509_crt);//分配空间并置空
    ...
    ALLOC_OBJ_CLEAR(ssl_ctx->priv_key_pkcs11, mbedtls_pkcs11_context);//分配空间并置空
    ...
    ALLOC_OBJ_CLEAR(ssl_ctx->priv_key, mbedtls_pk_context);//分配空间并置空
